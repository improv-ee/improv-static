<template>
    <div>
        <div class="row">
            <p class="text-center mb-4">Vaata truppide ajalugu visuaalselt <NuxtLink to="/impropuu">Impropuu</NuxtLink>-lt.</p>
        </div>
        <div class="row row-cols-1 row-cols-md-2 g-4">
            ...
            <OrganizationCard name="Ruutu10" image="/img/ruutu10.jpg" link="https://ruutu10.ee">
                <template #description>
                    ...
                    <p>Kujuta ette, et sa istud koos oma parimate sõpradega. Iga uus mõte, mis välja öeldakse on
                        naljakam
                        kui eelmine,
                        samal ajal te kõik teadvustate endale “kui loll see on”. See on selline hetk, mida sa ei saa
                        edasi
                        rääkida.
                    ...
                    <p class="lead text-center">Naer vabastab!</p>
                </template>
            </OrganizationCard>
            ...
            <OrganizationCard name="Improteater IMPEERIUM" image="/img/impeerium.jpg" link="https://improimpeerium.ee/">
                <template #description>
                    <p>Improteater IMPEERIUM kasvas välja 2014. aastal esimesest professionaalsest improtrupist Eestis.
                        ...
                        draamatruppidesse või tegutsevad vabakutselistena erinevates teatri-, tele- ja filmiprojektides.
                        Peale näitlejate on IMPEERIUMis ka andekad muusikud ning suurepärased valguskunstnikud, kes
                        aitavad
                        levitada improarmastust Eestis.</p>

                    <p>Impros ei tea keegi, mis juhtuma hakkab, kuid kõik on võimalik! Ladinakeelne sõna ’imperium’
                        tähendab
                        võimu.
            ...
            <OrganizationCard name="Ehatäht" image="/img/eha.jpg" link="https://www.facebook.com/ehat2ht/">
                <template #description>
                    ...
                    <p>Improtruppi Ehatäht saab kutsuda esinema sünnipäevadele,
                        koosviibimistele, firmaüritustele, koduhoovi jne.</p>

                    <p class="lead text-center">Ma ütlen EHA, ma ütlen TÄHT, ma ütlen EHATÄHT! Impromaailmas on kõik
                        võimalik!</p>
                </template>
            </OrganizationCard>
            ...
            <OrganizationCard name="Eesti Improteater" image="/img/improteater.jpg" link="http://www.improteater.ee/">
                <template #description>
                    <p>2009. aastal haaras improteatri õppimise võimalusest kinni hulk noori TÜ Viljandi
                        Kultuuriakadeemia
                        lõpetajaid ja nendega koos panimegi kassi katusele: 2009. aasta 29. oktoobril läksime No99
                        Teatris
                        esimest korda teksti, laule või samme õppimata lavale etendust mängima, lootes vaid iseendale ja
                        oma
            ...
            <OrganizationCard name="Kahe Vahel" image="/img/kahe-vahel.jpg" link="https://ruutu10.ee/">
                <template #description>
                    <p>Nad on kaks sõpra, Märt ja Kristjan, kelle koostöö on kestnud juba mitu hooaega. Kahekesi laval
                        hakkama saamine on väljakutse, mille nad alati rõõmuga vastu võtavad ja millega meisterlikult
                        toime
                    ...
                    <p>
                        ...
                        inspireeruvad muusika emotsioonist ning seejärel improviseerivad kuni 30 minuti pikkuse
                        näidendi.
                        Raske on ette ennustada, millest nende lugu räägib, kuid seni on need olnud südamlikud,
                        koomilised
                        ja kaasahaaravad.</p>
                </template>
            </OrganizationCard>
            <OrganizationCard name="kIMPROose" image="/img/kimproose.jpg" link="https://www.facebook.com/kimproose">
                <template #description>
                    ...
                    <p>kIMPROose etteasted on lustakad, muusikalised, krutskitega ning täis erinevaid põnevaid pöördeid.
                        Armastame avastada laval uusi suhteid ja tegelasi ning vaadata, kuhu see kõik lõpuks kokku viib.
                    </p>
                </template>
            </OrganizationCard>
        </div>
