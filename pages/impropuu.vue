...
const elements = ref([
    ...
    { type: 'origin', id: 'rednar', label: 'Rednar Annus', position: { x: 900, y: 0 }, data: { years: { start: 2008 } } },
    { type: 'origin', id: 'rahel', label: 'Rahel Otsa', position: { x: 600, y: 0 }, data: { years: { start: 2008 } } },

    { type: 'group', id: 'improteater', label: 'Eesti Improteater', position: { x: 850, y: 150 }, data: { years: { start: 2009 } } },
    { type: 'group', id: 'neljapaevane-annus', label: 'Neljapäevane Annus', position: { x: 1400, y: 250 }, data: { years: { start: 2016 } } },
    { type: 'archived', id: 'jaa', label: 'Improgrupp Jaa!', position: { x: 0, y: 300 }, data: { otherNames: ["Jaa Improteater"], years: { start: 2009, end: 2019 } } },
    { type: 'group', id: 'improkool', label: 'Rahel Otsa Improkool', position: { x: 400, y: 300 }, data: { years: { start: 2022 } } },

    { type: 'group', id: 'impeerium', label: 'Improteater IMPEERIUM', position: { x: 850, y: 300 }, data: { years: { start: 2013 } } },
    { type: 'group', id: 'ruutu10', label: 'Ruutu10', position: { x: 650, y: 1200 }, data: { otherNames: ["Improkraatia"], years: { start: 2013 } } },
    { type: 'archived', id: 'raheljatimo', label: 'Rahel ja Timo', position: { x: 0, y: 500 }, data: { years: { start: 2017, end: 2018 } } },

    { type: 'group', id: 'ehataht', label: 'Ehatäht', position: { x: 1400, y: 400 }, data: { years: { start: 2016 } } },
    { type: 'archived', id: 'jargmisekorrani', label: 'Järgmise Korrani', position: { x: 1000, y: 500 }, data: { years: { start: 2019, end: 2024 } } },
    { type: 'group', id: 'smuuti', label: 'Smuuti', position: { x: 1500, y: 600 }, data: { years: { start: 2021 } } },
    { type: 'archived', id: 'paavst', label: 'Paavst tuleb homme', position: { x: 750, y: 500 }, data: { years: { start: 2020, end: 2022 } } },
    { type: 'group', id: 'kimproose', label: 'kIMPROose', position: { x: 800, y: 730 }, data: { years: { start: 2022 } } },
    { type: 'group', id: 'improovijad', label: 'Improovijad', position: { x: 1200, y: 550 }, data: { years: { start: 2023 } } },
    ...
    { type: 'archived', id: 'komejant', label: 'Komejant', position: { x: 1600, y: 1600 }, data: { years: { start: 2016, end: 2017 } } },
...
<template>
    <div>
        ...
        <p style="margin-top: 10em">Info ebaõige või grupp puudu? Kirjuta või saada <a
                href="https://github.com/improv-ee/improv-static/blob/main/pages/impropuu.vue">muudatusettepanek</a>.
        </p>
    </div>
</template>
